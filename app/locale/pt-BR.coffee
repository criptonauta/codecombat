module.exports = nativeDescription: "Português (Brasil)", englishDescription: "Portuguese (Brazil)", translation:
  ...
  new_home:
    built_for_teachers_title: "Um jogo de programação construído com professores em mente"
    built_for_teachers_blurb: "Ensinar as crianças a programar muitas vezes pode parecer fora do alcance. O CodeCombat ajuda os educadores a ensinar os alunos a programação em JavaScript ou Python, duas das linguagens de programação mais populares. Com um currículo abrangente - que inclui seis unidades de ciência da computação e reforça o aprendizado através do desenvolvimento de jogos baseados em projetos e unidades de desenvolvimento web - as crianças progridem em uma jornada da sintaxe básica à recursão!"
    built_for_teachers_subtitle1: "Ciências da Computação"
    built_for_teachers_subblurb1: "Começando com nosso curso gratuito de Introdução à Ciência da Computação, os alunos dominam os principais conceitos de programação, como loops while/for, funções e algoritmos."
    ...
    built_for_teachers_subblurb3: "Usando HTML, CSS e jQuery, os alunos exercitam seus músculos criativos para programarem suas próprias páginas da Web com um URL personalizado para compartilhar com seus colegas de classe."
    ...
    century_skills_quote3: "Se eu ficasse preso em um nível... Eu trabalharia com as pessoas ao meu redor até que todos pudéssemos descobrir."
    ...
    century_skills_quote4: "Sempre tive aspirações de criar videogames e aprender a programar ... isso está me dando um excelente ponto de partida."
    century_skills_subtitle4: "Comunicação"
    century_skills_subblurb4: "A programação exige que as crianças pratiquem novas formas de comunicação, incluindo a comunicação com o próprio computador e a transmissão de suas idéias usando o código mais eficiente."
    classroom_in_box_title: "Nós nos esforçamos para:"
    classroom_in_box_blurb1: "Envolver todos os alunos para que eles acreditem que a programação é para eles."
    classroom_in_box_blurb2: "Capacitar qualquer educador a se sentir confiante ao ensinar programação."
    classroom_in_box_blurb3: "Inspirar todos os líderes escolares para criar um programa de ciência da computação de classe mundial."
    creativity_rigor_title: "Onde a criatividade encontra o rigor"
    creativity_rigor_subtitle1: "Torne a programação divertida e ensine habilidades do mundo real"
    creativity_rigor_blurb1: "Os alunos realmente digitam em Python e JavaScript enquanto jogam jogos que incentivam a tentativa e erro, o pensamento crítico e a criatividade. Os alunos então aplicam as habilidades de programação que aprenderam, desenvolvendo seus próprios jogos e sites em cursos baseados em projetos."
    ...
    creativity_rigor_subtitle3: "Feito para todos os professores, independentemente da experiência"
    ...
    for_leaders_subtitle2: "Currículo Completo de programação"
    ...
    for_leaders_subblurb3: "Se você quer construir uma classe eletiva de programação da Escola Secundária, uma via de CTE, ou uma classe de Princípios da Ciência da Computação AP, o CodeCombat é adaptado para atender às suas necessidades."
    for_leaders_subtitle4: "Habilidades do mundo real"
    for_leaders_subblurb4: "Os alunos constroem a coragem e desenvolvem uma mentalidade de crescimento através de desafios de programação que os preparam para os trabalhos de computação aberta de 500K +."
    ...
    quotes_quote3: "O CodeCombat tem sido o mais benéfico para ensinar aos alunos a capacidade de programação da vida real. Meu marido é engenheiro de software e testou todos os meus programas. Ele colocou isso como sua melhor escolha."
...
#    assessments_curriculum_desc: "Learn how to use Challenge Levels and Combo Challenge levels to assess students' learning outcomes."
    ...
    office_hours_detail: "Aprenda a acompanhar seus alunos enquanto eles criam jogos e embarcam em sua jornada de programação! Venha e participe do nosso"
...
#    sync_google_classroom: "Sync Google Classroom"
  ...
  ladder:
    ...
    tournament_blurb_zero_sum: "ULibere sua criatividade de programação em colagens de ouro e táticas de batalha neste jogo de espelho alpino entre o feiticeiro vermelho e o feiticeiro azul. O torneio começou na sexta-feira, 27 de março, e vai até segunda-feira, 6 de abril, às 17h PDT. Venha competir por diversão e glória! Confira os detalhes"
